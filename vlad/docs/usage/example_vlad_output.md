The following is the typical output generated from a 'vagrant up' in a Vlad project. The actual output will vary depending on the settings selected in the settings.yml file.

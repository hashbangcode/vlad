The following is the typical output generated from a 'vagrant up' in a Vlad project. The actual output will vary depending on the settings selected in the settings.yml file. You can see all of the output for your Vlad initialisation by looking at the ansible.log file that is generated by all Ansible runs on the Vagrant box.

...
<html lang="en">
<head>
    <!-- Vlad Ansible managed: /Users/philipnorton42/Development/vlad/vlad_guts/playbooks/templates/index.j2 modified on 2015-10-20 21:37:00 by philipnorton42 on Philips-MacBook-Pro.local -->
    <meta charset="utf-8">
...
<div class="row">
    <div class="col-lg-6">
        ...
        replacing everything in the <var>./docroot</var> directory or by using one of the two
        ...
        <p>Out of the box Vlad is ready to run a Drupal site. Simply put the code in the <var>./docroot</var> directory and run either use the >web installer or install the site using drush:</p>
        <pre class="prettyprint linenums">
$ cd /var/www/site/./docroot
$ drush site-install profile_name --db-url=mysql://vlad:wibble@localhost/['vladdb'] --account-name=admin --account-pass=password --yes
</pre>
        ...
        <p>Go to <a href="//drupal.local">drupal.local</a> in your browser and the site is rocking.</p>

        <h3>Developing</h3>
        <p>All your files are actually located on your host machine in the <var>./docroot</var>-directory
...
$ vagrant ssh
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <dl>
                                        ...
                                        <dt><a href="http://adminer.drupal.local/">Adminer</a></dt>
                    ...
                    <dd>XDebug is a PHP debugging and profiling tool. To use the debugger, point your IDE at this
                        box IP address (<var>192.168.100.100</var>) and use port 9000. >You can also trigger the XDebug profiler by appending
                        "XDEBUG_PROFILE=true" to the URL (i.e.
                        <a href="http://drupal.local/?XDEBUG_PROFILE=true">http://drupal.local/?XDEBUG_PROFILE=true</a>).
                    </dd>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <p>Yes, it is easy to run several sites on the same box. You just put them in different folders in <var>/var/www/site/./docroot/</var>.
                You can create new databases using <a
                        href="http://adminer.drupal.local:8080/?username=vlad">Adminer</a></p>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="col-lg-6">
                ...
                <p>MySQL can be administered with <a href="http://adminer.drupal.local/">Adminer</a>. But also
                    directly
